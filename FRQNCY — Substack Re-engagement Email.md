# Re-engagement Email — Substack Cold List
*Send this to your 4,000 dormant crypto subscribers as a one-time reintroduction.*
*Import the Substack CSV into Brevo as a separate list called "Substack Cold 2023" first.*
...
- Send from: hello@frqncy.network
- List: Substack Cold 2023 (keep separate from main FRQNCY Waitlist)
- Wait 48 hours after sending before reviewing open rates
- Anyone who opens OR clicks → manually move to your main FRQNCY Waitlist in Brevo
- Anyone who unsubscribes → Brevo handles automatically
- Expected open rate on a cold 2-year list: 8–15%. That's 320–600 real people who are still interested. Worth it.
- Do NOT send a follow-up to non-openers for at least 4 weeks — give their email clients time to classify you as legitimate
