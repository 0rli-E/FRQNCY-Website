    ...
    <div class="ai-reading-panel">
      ...
      <div class="ai-reading-footer">
        ${source === 'ai'
          ...
          : 'Based on your chart data and Human Design principles. For a deeper personalised reading, <a href="human-design/" style="color:var(--gold);text-decoration:underline">explore Human Design on FRQNCY</a>.'}
      </div>
    </div>
  `;
...
function renderGK(dob, tob, tzLabel, dateStr) {
  ...
  document.getElementById('ext-links').innerHTML = `
    ...
    <a href="gene-keys/index.html" class="ext-link">Gene Keys topic →</a>
  `;
}
