...
- [pi-ai and pi-agent-core](#pi-ai-and-pi-agent-core)
  - [There. Are. Four. Ligh... APIs](#there-are-four-ligh-apis)
  - [Context handoff](#context-handoff)
  - [We live in a multi-model world](#we-live-in-a-multi-model-world)
  - [Structured split tool results](#structured-split-tool-results)
  - [Minimal agent scaffold](#minimal-agent-scaffold)
- [pi-tui](#pi-tui)
  - [Two kinds of TUIs](#two-kinds-of-tuis)
  - [Retained mode UI](#retained-mode-ui)
  - [Differential rendering](#differential-rendering)
- [pi-coding-agent](#pi-coding-agent)
  - [Minimal system prompt](#minimal-system-prompt)
  - [Minimal toolset](#minimal-toolset)
  - [YOLO by default](#yolo-by-default)
  - [No built-in to-dos](#no-built-in-to-dos)
  - [No plan mode](#no-plan-mode)
  - [No MCP support](#no-mcp-support)
  - [No background bash](#no-background-bash)
  - [No sub-agents](#no-sub-agents)
...
*[Interactive demo in original post showing how only changed lines are redrawn]*
...
*[Video demo of websearch in original post]*
...
*[Video demo of tmux in original post]*
...
*[Video demo of subagent code review in original post]*
