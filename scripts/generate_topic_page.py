...
# Canonical global header — single source of truth: _chrome/global-header.html.
# Run `node scripts/sync-headers.mjs` after editing that file to propagate to bespoke pages.
...
<nav class="snav">
  ...
  <div style="display:flex;align-items:center;gap:0.75rem;flex-shrink:0">
    ...
    <!-- Universal back-one-step button — uses history.back() when there is
         a previous entry, falls back to "/" if the page was opened cold. -->
