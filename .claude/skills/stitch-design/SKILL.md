---
name: stitch-design
description: Unified design system entry point for creating and editing high-fidelity UI screens with Google Stitch MCP. Use when designing a new page, editing an existing Stitch screen, or generating/updating a .stitch/DESIGN.md source-of-truth file.
---
